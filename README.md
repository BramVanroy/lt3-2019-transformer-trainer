...
Multi-label classification (and regression) was first added by Luna De Bruyne and later adapted and further improved 
 to be added to this repository. You can use it by setting the option `multi_label` to `true` in your config file
 ...
 of labels *per item* that you are predicting.
